...
class EntityType(BaseModel):
    ...
    path_template = fields.ForeignKeyField('models.EntityType', related_name='path_template')
...
class Entity(BaseModel):
    ...
    casting = fields.ManyToManyField('models.Entity', related_name='casted', through='entity_casting')
